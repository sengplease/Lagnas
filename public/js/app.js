  ...
  class Component extends App{
    ...
    <nav>
      <div class="nav-wrapper  cyan">
      	<img src="img/photo.jpg" width ="70px">
          ...
          <div class="col s12 m12">
            <div class="card horizontal small">
              ...
              <div class="card-action small">               
                  <a href="#"><span onclick="component.albumDelete(${r.id})" class="new badge small red" data-badge-caption="">Delete</span></a>
                 <a href="#"><span onclick="component.albumList()" class="new badge small" data-badge-caption="">Albums</span></a>
                 <a href="#"><span onclick="component.updatePage(${r.id})" class="new badge small" data-badge-caption="">Update</span></a>
                </div>            
              </div>     
            </div>   
     ...
     let r = this.SearchAlbumById(id);
      ...
      <div class="row">
        <div class="input-field col s6">
          <input value="${r.name}" id="nameupdate" type="text" class="validate">
          <label for="nameupdate">Album Name...</label>
        </div>
        <div class="input-field col s6">
          <input value="${r.image}" id="imageupdate" type="text" class="validate">
          <label for="imageupdate">Album Image...</label>
        </div>  
        <br>
        
         <a href="#"><span onclick="component.viewAlbum(${r.id})" class="new badge small" data-badge-caption="">Back</span></a>
        <a href="#"><span onclick="component.update(${r.id})" class="new badge small" data-badge-caption="">Update</span></a>
    ...
    update(id){
      ...
      let all = {"id": r, "name" :name.value,"image": image.value, "description": d.description };
      console.log(all);
         ...
         <div class="col">
            ...
            <div align="center">
              <div class="input-field col s6 ">
                ...
                <label for="kill4"> Enter Image Link:</label>
              </div>
          <div align="center">
